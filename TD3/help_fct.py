...
def fuse_folders(number, args):
    ...
    final_folder = f"./logs/{number}_ID{args.model_ID}_assets{args.num_paths}_window{args.window_size}_batchsize{args.batch_size}_learning_rate{args.learning_rate}_{args.statement}"
